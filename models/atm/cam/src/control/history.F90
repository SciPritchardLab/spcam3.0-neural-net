...
! SR: Additional debug outputs to check T at several stages
      ...
      call addfld ('NNDTFIX','K/s     ',pver, 'A','T tendency - NNDT post Lin-Pritchard bias corrector',phys_decomp)
      call addfld ('NNDQ ','kg/kg/s ',pver, 'A','Q tendency - neural net for moist convection',phys_decomp)
      call addfld ('NNDQFIX','kg/kg/s ',pver, 'A','Q tendency - NNDQ opst Lin-Pritchard bias corrector',phys_decomp)
