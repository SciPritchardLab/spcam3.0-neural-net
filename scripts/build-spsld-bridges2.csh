...
#    $cfgdir/configure_mmf -fflags "-DCLOUDBRAIN -DNEURALLIB -DBRAINDEBUG -DHDEBUG" -fc mpif90 -cc cc -spmd -smp -dyn sld -res 64x128 -pcols 8 -nlev 30 -cam_exedir $rundir -mpi_inc $MPICH_DIR/intel64/include -mpi_lib $MPICH_DIR/intel64/lib/release || echo "configure failed" && exit 1
