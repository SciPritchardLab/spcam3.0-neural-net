...
#ifdef QVORTDAMP
   real(r8), allocatable :: u3aux(:,:,:,:)
   real(r8), allocatable :: v3aux(:,:,:,:)
   real(r8), allocatable :: u3sldaux(:,:,:)
   real(r8), allocatable :: v3sldaux(:,:,:)
#endif
...
#ifdef QVORTDAMP
    allocate (u3aux(plond,plev            ,beglatex:endlatex,ptimelevels))
    allocate (v3aux(plond,plev            ,beglatex:endlatex,ptimelevels))
#endif
...
#ifdef QVORTDAMP
    allocate (u3sldaux(plond,plev,beglatex:endlatex))
    allocate (v3sldaux(plond,plev,beglatex:endlatex))
#endif
