...
! SR: Implementing new variables to check NN input/output
      ...
      call addfld ('NNT_adiab','K     ',pver, 'A','TC into NN',phys_decomp)
      call addfld ('NNQ_adiab','K     ',pver, 'A','TC into NN',phys_decomp)
      call addfld ('NNQC_adiab','K     ',pver, 'A','TC into NN',phys_decomp)
      call addfld ('NNQI_adiab','K     ',pver, 'A','TC into NN',phys_decomp)
      call addfld ('NNV_adiab','K     ',pver, 'A','TC into NN',phys_decomp)
...
! SR: Additional debug outputs to check T at several stages
      ...
      call addfld ('NNPRECTEND','W/m2',1,'A','Neural net estimated OLR (W/m2, I think',phys_decomp) 
      call addfld ('NNPRECST','W/m2',1,'A','Neural net estimated OLR (W/m2, I think',phys_decomp) 
      call addfld ('NNPRECSTEN','W/m2',1,'A','Neural net estimated OLR (W/m2, I think',phys_decomp) 
      call addfld ('NNQRS','K     ',pver, 'A','TC into NN',phys_decomp)
      call addfld ('NNQRL','K     ',pver, 'A','TC into NN',phys_decomp)
      call addfld ('NNDTVKE','K     ',pver, 'A','TC into NN',phys_decomp)
