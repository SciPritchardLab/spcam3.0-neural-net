...
!  use runtime_opts, only: subregional_moisture_constraint ! pritch
...
!    if (subregional_moisture_constraint) then
!       call pbuf_add('QBFR','physpkg',1,pver,96, flag)
!       call pbuf_add('QREF','physpkg',1,pver,1,flag)
!    endif
