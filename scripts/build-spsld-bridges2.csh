...
set wrkdir       = $PROJECT/smoketestSP
...
# for SP control run activate this version:
    $cfgdir/configure_mmf -fc mpiifort -cc cc -spmd -smp -dyn sld -res 64x128 -pcols 8 -nlev 30 -cam_exedir $rundir -mpi_inc $MPICH_DIR/intel64/include -mpi_lib $MPICH_DIR/intel64/lib || echo "configure failed" && exit 1
