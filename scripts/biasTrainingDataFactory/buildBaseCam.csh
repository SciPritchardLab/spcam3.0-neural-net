...
set wrkdir       = /work/08110/tg874091/stampede2/biasTrainingDataFactory/baseline
...
#    $cfgdir/configure_mmf -fflags "-DSPFLUXBYPASS" -fc mpif90 -cc cc -spmd -smp -dyn sld -res 64x128 -pcols 8 -nlev 30 -cam_exedir $rundir -mpi_inc $MPICH_DIR/intel64/include -mpi_lib $MPICH_DIR/intel64/lib || echo "configure failed" && exit 1
