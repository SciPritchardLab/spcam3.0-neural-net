...
! dyn_state:
   ...
   real(r8), allocatable :: q3old(:,:,:,:) ! Moisture and constituents
...
! phys_state:
   ...
   real(r8), allocatable ::   t3old(:,:,:)    ! Temperature previous timestep
...
! !LOCAL VARIABLES:
   integer :: i, j, k, m
      ...
      allocate (t3old  (plon, beglev:endlev, beglat:endlat))
      ...
      allocate ( q3old(plon, beglat-ng_d:endlat+ng_d, beglev:endlev, ppcnst) )
