...
!
    ...
    real(r8) :: z0hg_pft !roughness length, sensible heat(pft level) [m]
    real(r8) :: z0qg_pft !roughness length, latent heat (pft level) [m]
...
!-----------------------------------------------------------------------
    ...
    do iter = 1, niters
       ...
       displa = 0.0_r8
       call FrictionVelocity(displa, z0mg, z0hg_pft, z0qg_pft, obu, &
       ...
       tstar = temp1*dth
       qstar = temp2*dqh
       z0hg_pft = z0mg/exp(0.13 * (ustar*z0mg/1.5e-5)**0.45)
       z0qg_pft = z0hg_pft
