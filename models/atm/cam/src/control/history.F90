...
!
      ...
      call addfld ('NNPRECL','mm/day',1,'A','Neural net estimated rain rate (mm/day, I think',phys_decomp) 
      call addfld ('NNPRECS','mm/day',1,'A','Neural net estimated rain rate (mm/day, I think',phys_decomp) 
...
! SR: Additional debug outputs to check T at several stages
      ...
      call addfld ('SPRE','K     ',pver, 'A','Pre BRAIN S',phys_decomp)
      call addfld ('SPOST','K     ',pver, 'A','Post BRAIN S',phys_decomp)

      call addfld ('TEPRE_R','K     ',1, 'A','Pre RAD TE',phys_decomp)
      call addfld ('TWPRE_R','K     ',1, 'A','Pre RAD TW',phys_decomp)
      call addfld ('TEPOST_R','K     ',1, 'A','Post RAD TE',phys_decomp)
      call addfld ('TWPOST_R','K     ',1, 'A','Post RAD TW',phys_decomp)
      ...
      call addfld ('NNDT2','K/s     ',pver, 'A','T tendency - neural net (after energy fix)',phys_decomp)
      ...
      call addfld ('NNDQ2','kg/kg/s ',pver, 'A','Q tendency - neural net post energy fix',phys_decomp)
