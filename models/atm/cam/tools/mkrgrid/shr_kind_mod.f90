!===============================================================================
! CVS: $Id: shr_kind_mod.f90,v 1.1.2.1 2002/06/15 13:50:08 erik Exp $
! CVS: $Source: /fs/cgd/csm/models/CVS.REPOS/tools/atm_tools/ccm_src/mkrgrid/Attic/shr_kind_mod.f90,v $
! CVS: $Name:  $
!===============================================================================
