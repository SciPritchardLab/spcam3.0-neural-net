...
!
      ...
      call addfld ('NNPRL','mm/day',1,'A','Neural net estimated rain rate (mm/day, I think',phys_decomp) 
      call addfld ('NNPRS','mm/day',1,'A','Neural net estimated rain rate (mm/day, I think',phys_decomp) 
      ...
      call addfld ('CNNPRL','mm/day',1,'A','Neural net estimated rain rate (mm/day, I think',phys_decomp) 
      call addfld ('CNNPRS','mm/day',1,'A','Neural net estimated rain rate (mm/day, I think',phys_decomp) 
      call addfld ('CNNFSNT','W/m2',1,'A','Neural net estimated OLR (W/m2, I think',phys_decomp) 
      call addfld ('CNNFSNS','W/m2',1,'A','Neural net estimated OLR (W/m2, I think',phys_decomp) 
      call addfld ('CNNFLNT','W/m2',1,'A','Neural net estimated OLR (W/m2, I think',phys_decomp) 
      call addfld ('CNNFLNS','W/m2',1,'A','Neural net estimated OLR (W/m2, I think',phys_decomp) 
      call addfld ('NNOLR','W/m2',1,'A','Neural net estimated OLR (W/m2, I think',phys_decomp) 
...
! MSP: for redundantly tracking total tendency after physics package (so we know MSE budget residual magnitude exactly)
      ...
      call addfld ('NNQCAP','kg/kg ',pver,'A','Q into NN',phys_decomp)
      call addfld ('NNQIAP','kg/kg ',pver,'A','Q into NN',phys_decomp)
! SR: Implementing new variables to check NN input/output
      ...
      call addfld ('NNQCBP','K     ',pver, 'A','TC into NN',phys_decomp)
      call addfld ('NNQIBP','K     ',pver, 'A','TC into NN',phys_decomp)
...
! SR: Additional debug outputs to check T at several stages
      ...
      call addfld ('NNDQC ','kg/kg/s ',pver, 'A','Q tendency - neural net for moist convection',phys_decomp)
      call addfld ('NNDQI ','kg/kg/s ',pver, 'A','Q tendency - neural net for moist convection',phys_decomp)
      call addfld ('CNNDT ','K/s     ',pver, 'A','T tendency - Gentine-Pritchard neural net for moist convection',phys_decomp)
      call addfld ('CNNDQ ','kg/kg/s ',pver, 'A','Q tendency - neural net for moist convection',phys_decomp)
      call addfld ('CNNDQC ','kg/kg/s ',pver, 'A','Q tendency - neural net for moist convection',phys_decomp)
      call addfld ('CNNDQI ','kg/kg/s ',pver, 'A','Q tendency - neural net for moist convection',phys_decomp)
