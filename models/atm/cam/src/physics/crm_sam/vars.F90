...
!------------------------------------------------------------------
! For some strange reason, on IBM SP when running OpenMP threads, 
! declaring memory in common-blocks make it much faster (as of Jan 2007)
common/comvar1/ u,v,w
common/comvar2/ t,q,qp
common/comvar3/ tke,tk,tkh
common/comvar4/ p,tabs,qn
common/comvar5/ dudt,dvdt,dwdt
common/comvar6/misc
common/comvar7/ fluxbu,fluxbv,fluxbq,fluxbt,fluxtu,fluxtv,fluxtq,fluxtt,&
                fzero,precsfc,precssfc
common/comvar8/t0,q0,qc0,qv0,tabs0,qi0,tv0,rel0,u0,v0
common/comvar9/tg0,qg0,ug0,vg0,p0,tke0,t01,q01
common/comvar10/ sstobs, lhobs, shobs, gamt0, gamq0
common/comvar11/prespot,rho,rhow,bet,betp, &
                gamaz,wsub,qtend,ttend,utend,vtend
common/comvar12/sstxy,fcory,fcorzy,latitude,longitude,prec_xy,shf_xy,lhf_xy, &
      lwns_xy,swns_xy,lwnsc_xy,swnsc_xy,lwnt_xy,swnt_xy,lwntc_xy,swntc_xy, &
      solin_xy,pw_xy,cw_xy,iw_xy,u200_xy,usfc_xy,v200_xy,vsfc_xy,w500_xy,qocean_xy
common/comvar13/qtend_cup,ttend_cup,utend_cup,vtend_cup
common/comvar14/ twle, twsb, qwle, qwsb, tkewle, &
      tkewsb, qpwle, qpwsb, precflux, &
      uwle, uwsb, vwle, vwsb, &
      cloud_factor, core_factor, coredn_factor, &
      tkeleadv, tkelepress, tkelediss, tkelediff, &
      tkesbbuoy, tkesbshear,tkesbdiss, tkesbdiff, &
      tkelebuoy, radlwup, radlwdn, radswup, radswdn, &
      radqrlw, radqrsw, w_max, s_acld, s_acldcold, s_ar, p_conv, p_strat, &
      s_acldl, s_acldm, s_acldh, s_acldisccp, &
      s_acldlisccp, s_acldmisccp, s_acldhisccp, &
      s_flns,s_flnt,s_flnsc,s_flntc,s_flds,s_fsns, &
      s_fsnt,s_fsnsc,s_fsntc,s_fsds,s_solin, &
      ...
      momlediff,tadv,tdiff,tlat, tlatqi, qifall, &
      qadv,qdiff,qpadv,qpdiff,qpsrc,qpfall,qpevp
common/comvar15/total_water_before, total_water_after, &
                total_water_evap, total_water_prec, total_water_ls

!$OMP threadprivate (/comvar1/,/comvar2/,/comvar3/,/comvar4/,/comvar5/)
!$OMP threadprivate (/comvar6/,/comvar7/,/comvar8/,/comvar9/,/comvar10/)
!$OMP threadprivate (/comvar11/,/comvar12/,/comvar13/,/comvar14/,/comvar15/)
