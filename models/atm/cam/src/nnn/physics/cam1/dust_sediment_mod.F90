...
!---------------------------------------------------------------------------------
  ...
  real (r8), parameter :: vland  = 2.8            ! dust fall velocity over land  (cm/s)
  real (r8), parameter :: vocean = 1.5            ! dust fall velocity over ocean (cm/s)
...
! initialize variables
    fxdust  (:ncol,:) = 0. ! flux at interfaces (dust)
    dusttend(:ncol,:) = 0. ! tend (dust)
    sfdust(:ncol)     = 0. ! sedimentation flux out bot of column (dust)
