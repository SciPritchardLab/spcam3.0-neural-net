...
## CausalSingleNNsCAM
set casenm       = CausalNNsCAM3.0_test1.3
set nnmodels     = CausalSingleNN/a0.001-t0.15/hl_32_32_32-act_relu-e_4_1month
...
ln -s $rpath/run_dir/run.slurm $srundir/run.slurm
if ! (! $?nnmodels) then       
  echo "variable exists undefined"
