...
real(8) :: xi,xj,xnx,xny,ddx2,ddy2,pii,eign
...
call t_stopf('press_1')
call t_startf('press_2')
...
do j=1,nyp22
   ...
   do i=1,nxp1
      ...
      eign = (2._8*cos(2._8*xnx*xi)-2._8)*ddx2+ & 
             (2._8*cos(2._8*xny*xj)-2._8)*ddy2
      if(id+jd.eq.0) then               
...
call t_stopf('press_2')
call t_startf('press_3')
call task_barrier()
