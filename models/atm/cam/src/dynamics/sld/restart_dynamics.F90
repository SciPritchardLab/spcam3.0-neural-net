...
#ifdef QVORTDAMP
      call wrtout_r8 (nrg,u3aux(1,1,begj,n3  )  ,plndlv)
      call wrtout_r8 (nrg,v3aux(1,1,begj,n3  )  ,plndlv)
#endif
...
#ifdef QVORTDAMP
      call wrtout_r8 (nrg,u3aux(1,1,begj,n3m1)  ,plndlv)
      call wrtout_r8 (nrg,v3aux(1,1,begj,n3m1)  ,plndlv)
#endif
...
#ifdef QVORTDAMP
      call wrtout_r8  (nrg,dqfcst(1,1,beglat),plndlv)
#endif
!
...
#endif
#ifdef QRLDAMP
  use qrl_anncycle, only: need_to_read_qrl
#endif
#include <comqfl.h>
!
! Input arguments
...
#ifdef QVORTDAMP
      call readin_r8 (nrg,u3aux(1,1,begj,n3  )  ,plndlv)
      call readin_r8 (nrg,v3aux(1,1,begj,n3  )  ,plndlv)
#endif
...
#ifdef QVORTDAMP
      call readin_r8 (nrg,u3aux(1,1,begj,n3m1)  ,plndlv)
      call readin_r8 (nrg,v3aux(1,1,begj,n3m1)  ,plndlv)
#endif
...
#ifdef QVORTDAMP
      call readin_r8 (nrg,dqfcst(1,1,beglat),plndlv)
#endif
!
