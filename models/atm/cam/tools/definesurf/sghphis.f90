subroutine sghphis (plon, plat, numlons, mlatcnts, mloncnts, & 
                    topofile, verbose, sgh, phis, fland )
...
!
   ...
   real(r8), intent(out):: sgh(plon,plat)      ! model standard dev of geopotential height
...
! high resolution topo grid 
   ...
   integer htopoid,ftopoid,ret          ! input topo file vars
   ...
   real(r8) ftopo(ntopolon,ntopolat)    ! Topographic 1/0 flag array 
