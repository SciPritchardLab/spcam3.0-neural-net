...
! !PUBLIC DATA MEMBERS:
   ...
   type (ghosttype), save  :: ghostu_xy, ghostu_yz, ghostv_yz, ghostq_yz,    &
                              ghostpe_xy, ghostpe_yz, ghostp_yz, ghostpe1_yz
   type (parpatterntype)   :: u_to_uxy, uxy_to_u, v_to_vxy, vxy_to_v,   &
                              ...
                              pe_to_pexy, pexy_to_pe, pt_to_ptxy,       &
                              ptxy_to_pt, pkxy_to_pkc,                  &
                              q3_to_qxy3, qxy3_to_q3, r_to_rxy, rxy_to_r
!
! !DESCRIPTION: 
...
#if defined( TWOD_YZ )
      integer npr_yz(4)
      integer geopktrans, tracertrans
      namelist /mprun2d/ npr_yz, geopktrans, tracertrans
#endif
...
! Define task indexing for 2D decomposition
      ...
      if (masterproc) then
        ...
        write (6,*) 'geopk communication method = ', geopktrans
        write (6,*) 'number of tracers simultaneously transposed = ', tracertrans
      endif
      ...
      call mpi_bcast(geopktrans, 1, mpiint, 0, mpicom, ier)
      call mpi_bcast(tracertrans, 1, mpiint, 0, mpicom, ier)
      geopk16byte = .false.
      if (geopktrans .ne. 0) geopk16byte = .true.
      m_ttrans = tracertrans
#endif
