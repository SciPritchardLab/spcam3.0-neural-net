...
! Author:  B. Collins
!
! $Id: radae.F90,v 1.10.4.10 2003/10/23 21:53:47 jmccaa Exp $
!------------------------------------------------------------------------------
...
subroutine radabs(lchnk   ,ncol1    ,ncol      , &
...
subroutine radems(lchnk   ,ncol1   ,ncol    ,                &
...
subroutine radtpl(lchnk   ,ncol1   ,ncol    ,                         &
...
!+WDC 11/29/00
!
!     Read in the absorptivity and emissivity for Collins/Lee-Taylor/Edwards 
!          method
!
   if ( masterproc ) then
