...
#ifdef QVORTDAMP
                     u3aux,u3auxm1,v3aux,v3auxm1,u3sldaux,v3sldaux, &
#endif
...
#ifdef QVORTDAMP
  real(r8), intent(in)   :: u3aux      (plond,plev)   ! u-wind (time n)
  real(r8), intent(inout):: u3auxm1    (plond,plev)   ! u-wind (time n-1)
  real(r8), intent(in)   :: v3aux      (plond,plev)   ! v-wind (time n)
  real(r8), intent(inout):: v3auxm1    (plond,plev)   ! v-wind (time n-1)
  real(r8), intent(inout):: u3sldaux   (plond,plev)   ! u-wind (time n) (used for advection)
  real(r8), intent(inout):: v3sldaux   (plond,plev)   ! v-wind (time n) (used for advection)
#endif
...
#ifdef QVORTDAMP
              u3aux,v3aux,u3auxm1,v3auxm1,u3sldaux,v3sldaux, &
#endif
              parrsld ,nlon    )
