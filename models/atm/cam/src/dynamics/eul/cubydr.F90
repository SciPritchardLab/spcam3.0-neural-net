...
!-----------------------------------------------------------------------
!
! $Id: cubydr.F90,v 1.1.44.1 2002/06/15 13:47:40 erik Exp $
! $Author: erik $
!
!-----------------------------------------------------------------------
...
!
  ...
  if (icount.ne.nlon*plev) then
     write(6,*)'CUBYDR: Departure point out of bounds: ', &
          'jcen,icount,nlon*plev=',jcen,icount,nlon*plev
     call endrun
  end if
!
  return
